...
void transpose_inplace(Param in, cl::CommandQueue& queue, const bool conjugate,
	...
	static const vector<string> sources{ {transpose_inplace_cl, transpose_inplace_cl_len} };
    ...
    auto transpose =
        common::getKernel("transpose_inplace", sources, tmpltArgs, compileOpts, hashSources);
